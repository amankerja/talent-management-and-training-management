...
![WorkforceOS Banner](https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1400&q=80)
...
[![Google Gemini](https://img.shields.io/badge/AI-Gemini%202.5-4285F4?style=for-the-badge&logo=google)](https://ai.google.dev/)
[![License](https://img.shields.io/badge/License-Commercial%20Enterprise-emerald?style=for-the-badge)](https://github.com/amankerja/talent-management-and-training-management)
...
```mermaid
graph TD
    A[WorkforceOS Enterprise] --> B[1. Executive Strategic Cockpit]
    A --> C[2. Workforce Foundation & Movement]
    A --> D[3. Competency Framework & TNA Engine]
    A --> E[4. Learning & Annual Training Lifecycle]
    A --> F[5. 9-Box Talent & Succession Bench]
    A --> G[6. Performance & IDP Studio]
    A --> H[7. Manpower Planning MPP Studio]
    A --> I[8. People Intelligence AI Advisor]
```
