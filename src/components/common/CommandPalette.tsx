...
export const CommandPalette: React.FC = () => {
  ...
  const items: CommandItem[] = useMemo(
    () => [
      ...
      { id: 'performance-dev', label: '06. Performance & Individual Development Plan (IDP 70:20:10)', hint: 'Domain 06', icon: Compass, keywords: 'performance development idp 70 20 10 goals appraisal kpi', run: goTo('performance-dev') },
      { id: 'career-architecture', label: '06. Career Architecture & Progression Ladder Engine', hint: 'Domain 06', icon: TrendingUp, keywords: 'career architecture progression ladder jalur karier jenjang tingkat kualifikasi promosi gaji level grade', run: goTo('career') },
